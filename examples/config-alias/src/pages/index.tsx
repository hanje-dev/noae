  ...
  alias: {
    component: require.resolve('./src/components'),
      ...
      <ul>
        ...
        <li>
          <code>@@</code>，temporary directory，It's usually <code>src/.umi</code> directory.
        </li>
        <li>
          <code>umi</code>，project root directory.
        </li>
        <li>
          <code>react-router</code> and <code>react-router-dom</code>，for lock version
        </li>
        <li>
          <code>react</code> and <code>react-dom</code>，It's usually <code>16.x</code>{' '}
          version，However, if there are dependencies in the project, the dependent version in the
          project will be used first
        </li>
      </ul>
      <Footer />
    </div>
