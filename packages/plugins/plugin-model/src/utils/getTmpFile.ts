...
export const getTmpFile = (files: string[], extra: ModelItem[] = [], absSrcPath: string) => {
  ...
  return {
    providerContent: getProviderContent(imports, userModels, extraImports, extraModels),
    useModelContent: enable ? getUseModelContent() : 'export const useModel = undefined;',
  };
};
