import { IOpts as IBabelPresetUmiOpts } from '@noaejs/babel-preset-noae';
import {
  Html,
...
import { Express, NextFunction, RequestHandler } from '@noaejs/deps/compiled/express';
import webpack from '@noaejs/deps/compiled/webpack';
import { IRoute as IRouteProps, IRouteComponentProps } from '@noaejs/renderer-react';
...
export interface IApi extends PluginAPI {
  ...
  onGenerateFiles: IEvent<{ files: Array<{ event: string; path: string }> }>;
  ...
  modifyHTMLChunks: IModify<
    Array<string | { name: string; headScript?: boolean }>,
    {
      route: IRoute;
      type?: IBundlerConfigType;
...
export interface BaseIConfig extends IConfigCore {
  ...
  inlineLimit?: number;
  lessLoader?: object;
  links?: Array<Partial<HTMLLinkElement>>;
  ...
  metas?: Array<Partial<HTMLMetaElement>>;
  mpa?: object;
  mock?: { exclude?: string[] };
