import { init as initRequreHook } from '@noaejs/bundler-webpack/lib/requireHook';
import { init } from '@noaejs/deps/compiled/webpack';
import { createDebug } from '@noaejs/utils';
import { existsSync, readFileSync } from 'fs';
import { join } from 'path';

const debug = createDebug('noae:cli:initWebpack');
