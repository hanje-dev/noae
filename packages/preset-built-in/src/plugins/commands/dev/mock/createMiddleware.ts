import { NextFunction, Request, RequestHandler, Response } from '@noaejs/types';
import { chokidar, createDebug, lodash, signale } from '@noaejs/utils';
import { cleanRequireCache, IGetMockDataResult, matchMock } from './utils';

const debug = createDebug('noae:preset-build-in:mock:createMiddleware');
