import { IApi, NextFunction, Request, Response } from '@noaejs/types';
...
export default ({ api, sharedMap }: { api: IApi; sharedMap: Map<string, string> }) => {
  return async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (req.path === '/favicon.ico') {
      res.sendFile(join(__dirname, 'noae.png'));
