import { BundlerConfigType, IApi, webpack } from '@noaejs/types';
...
export default function (api: IApi) {
  ...
  class HtmlWebpackPlugin {
    apply(compiler: webpack.Compiler) {
      compiler.hooks.emit.tapPromise('NoaeHtmlGeneration', async (compilation): Promise<any> => {
        if (api.config.ssr) {
          // waiting noae.server.js emited
  ...
  api.modifyBundleConfig((bundleConfig, { env, mfsu, type, bundler: { id } }) => {
