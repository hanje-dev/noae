...
import cacache from '@noaejs/deps/compiled/cacache';
import findCacheDir from '@noaejs/deps/compiled/find-cache-dir';
...
export default class Webpack4Cache {
  ...
  async get(cacheData, { RawSource, ConcatSource, SourceMapSource }) {
    ...
    cacheData.cacheIdent = cacheData.cacheIdent || serialize(cacheData.cacheKeys);
    ...
    const { code, name, map, input, inputSourceMap, extractedComments, banner, shebang } =
      cachedResult;
