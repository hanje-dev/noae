...
import loaderUtils from '@noaejs/deps/compiled/loader-utils';
import { version as webpackVersion } from '@noaejs/deps/compiled/webpack';
import LibraryTemplatePlugin from '@noaejs/deps/compiled/webpack/LibraryTemplatePlugin';
import LimitChunkCountPlugin from '@noaejs/deps/compiled/webpack/LimitChunkCountPlugin';
import NodeTargetPlugin from '@noaejs/deps/compiled/webpack/NodeTargetPlugin';
import NodeTemplatePlugin from '@noaejs/deps/compiled/webpack/NodeTemplatePlugin';
import NormalModule from '@noaejs/deps/compiled/webpack/NormalModule';
import SingleEntryPlugin from '@noaejs/deps/compiled/webpack/SingleEntryPlugin';
  ...
  return `${content}
    if(module.hot) {
      ...
      var cssReload = require(${loaderUtils.stringifyRequest(
        context.context,
        winPath(path.join(__dirname, '../../../../../bundled/css/hotModuleReplacement.js'))
  ...
  childCompiler.runAsChild((err, entries, compilation) => {
    const addDependencies = (dependencies) => {
      if (!Array.isArray(dependencies) && dependencies != null) {
        throw new Error(
          `Exported value was not extracted as an array: ${JSON.stringify(dependencies)}`
        );
      }
