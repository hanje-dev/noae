...
import webpack, { version as webpackVersion } from '@noaejs/deps/compiled/webpack';
  ...
  renderContentAsset(compilation, chunk, modules, requestShortener) {
    ...
    for (const m of usedModules) {
      if (/^@import url/.test(m.content)) {
        ...
        if (m.sourceMap) {
          source.add(
            new SourceMapSource(m.content, m.readableIdentifier(requestShortener), m.sourceMap)
          );
        } else {
