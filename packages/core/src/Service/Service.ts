import { AsyncSeriesWaterfallHook } from '@noaejs/deps/compiled/tapable';
import { BabelRegister, lodash, NodeEnv } from '@noaejs/utils';
...
const logger = new Logger('noae:core:Service');
