...
externals['address'] = '@noaejs/deps/compiled/address';
...
externals['ansi-html'] = '@noaejs/deps/compiled/ansi-html';
export async function ncc_ansi_html(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('ansi-html')))
...
export async function ncc_babel_bundle(task, opts) {
  ...
  for (const pkg of Object.keys(babelBundlePackages)) delete bundleExternals[pkg];
  await task
...
const babelBundlePackages = {
  '@babel/code-frame': '@noaejs/deps/compiled/babel/code-frame',
  '@babel/core': '@noaejs/deps/compiled/babel/core',
  '@babel/parser': '@noaejs/deps/compiled/babel/parser',
  '@babel/template': '@noaejs/deps/compiled/babel/template',
  '@babel/generator': '@noaejs/deps/compiled/babel/generator',
  '@babel/register': '@noaejs/deps/compiled/babel/register',
  '@babel/traverse': '@noaejs/deps/compiled/babel/traverse',
  '@babel/types': '@noaejs/deps/compiled/babel/types',
  '@babel/preset-env': '@noaejs/deps/compiled/babel/preset-env',
  '@babel/preset-react': '@noaejs/deps/compiled/babel/preset-react',
  '@babel/preset-typescript': '@noaejs/deps/compiled/babel/preset-typescript',
};
...
externals['body-parser'] = '@noaejs/deps/compiled/body-parser';
export async function ncc_body_parser(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('body-parser')))
    .ncc({ packageName: 'body-parser', externals })
    .target('compiled/body-parser');
}

externals['chalk'] = '@noaejs/deps/compiled/chalk';
...
externals['cacache'] = '@noaejs/deps/compiled/cacache';
...
externals['cheerio'] = '@noaejs/deps/compiled/cheerio';
export async function ncc_cheerio(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('cheerio')))
    .ncc({ packageName: 'cheerio', externals })
    .target('compiled/cheerio');
}

externals['cliui'] = '@noaejs/deps/compiled/cliui';
export async function ncc_cliui(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('cliui')))
    .ncc({ packageName: 'cliui', externals })
    .target('compiled/cliui');
}

externals['color'] = '@noaejs/deps/compiled/color';
export async function ncc_color(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('color')))
    .ncc({ packageName: 'color', externals })
    .target('compiled/color');
}

externals['copy-webpack-plugin'] = '@noaejs/deps/compiled/copy-webpack-plugin';
...
externals['crequire'] = '@noaejs/deps/compiled/crequire';
export async function ncc_crequire(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('crequire')))
    .ncc({ packageName: 'crequire', externals })
    .target('compiled/crequire');
}

externals['cross-spawn'] = '@noaejs/deps/compiled/cross-spawn';
...
externals['css-loader'] = '@noaejs/deps/compiled/css-loader';
...
externals['css-modules-typescript-loader'] = '@noaejs/deps/compiled/css-modules-typescript-loader';
export async function ncc_css_modules_typescript_loader(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('css-modules-typescript-loader')))
    .ncc({ packageName: 'css-modules-typescript-loader', externals })
    .target('compiled/css-modules-typescript-loader');
}

externals['compression'] = '@noaejs/deps/compiled/compression';
...
externals['debug'] = '@noaejs/deps/compiled/debug';
...
externals['deepmerge'] = '@noaejs/deps/compiled/deepmerge';
export async function ncc_deepmerge(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('deepmerge')))
    .ncc({ packageName: 'deepmerge', externals })
    .target('compiled/deepmerge');
}

externals['dotenv'] = '@noaejs/deps/compiled/dotenv';
...
externals['ejs'] = '@noaejs/deps/compiled/ejs';
export async function ncc_ejs(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('ejs')))
    .ncc({ packageName: 'ejs', externals })
    .target('compiled/ejs');
}

externals['error-stack-parser'] = '@noaejs/deps/compiled/error-stack-parser';
export async function ncc_error_stack_parser(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('error-stack-parser')))
    .ncc({ packageName: 'error-stack-parser', externals })
    .target('compiled/error-stack-parser');
}

externals['execa'] = '@noaejs/deps/compiled/execa';
export async function ncc_execa(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('execa')))
    .ncc({ packageName: 'execa', externals })
    .target('compiled/execa');
}

externals['express'] = '@noaejs/deps/compiled/express';
...
externals['file-loader'] = '@noaejs/deps/compiled/file-loader';
...
externals['find-cache-dir'] = '@noaejs/deps/compiled/find-cache-dir';
...
export async function ncc_fork_ts_checker_webpack_plugin_bundle(task, opts) {
  ...
  await task
    .source(opts.src || relative(__dirname, require.resolve('fork-ts-checker-webpack-plugin')))
...
externals['friendly-errors-webpack-plugin'] =
  '@noaejs/deps/compiled/friendly-errors-webpack-plugin';
export async function ncc_friendly_errors_webpack_plugin(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('friendly-errors-webpack-plugin')))
    .ncc({ packageName: 'friendly-errors-webpack-plugin', externals })
    .target('compiled/friendly-errors-webpack-plugin');
}

externals['glob'] = '@noaejs/deps/compiled/glob';
...
externals['got'] = '@noaejs/deps/compiled/got';
export async function ncc_got(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('got')))
    .ncc({ packageName: 'got', externals })
    .target('compiled/got');
}

externals['html-entities'] = '@noaejs/deps/compiled/html-entities';
...
externals['http-proxy-middleware'] = '@noaejs/deps/compiled/http-proxy-middleware';
...
externals['immer'] = '@noaejs/deps/compiled/immer';
export async function ncc_immer(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('immer')))
...
externals['prompts'] = '@noaejs/deps/compiled/prompts';
...
externals['less'] = '@noaejs/deps/compiled/less';
...
externals['less-loader'] = '@noaejs/deps/compiled/less-loader';
...
externals['lodash'] = '@noaejs/deps/compiled/lodash';
...
externals['merge-stream'] = '@noaejs/deps/compiled/merge-stream';
...
externals['multer'] = '@noaejs/deps/compiled/multer';
export async function ncc_multer(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('multer')))
    .ncc({ packageName: 'multer', externals })
    .target('compiled/multer');
}

externals['mustache'] = '@noaejs/deps/compiled/mustache';
export async function ncc_mustache(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('mustache')))
    .ncc({ packageName: 'mustache', externals })
    .target('compiled/mustache');
}

externals['native-url'] = '@noaejs/deps/compiled/native-url';
...
externals['optimize-css-assets-webpack-plugin'] =
  '@noaejs/deps/compiled/optimize-css-assets-webpack-plugin';
export async function ncc_optimize_css_assets_webpack_plugin(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('optimize-css-assets-webpack-plugin')))
    .ncc({ packageName: 'optimize-css-assets-webpack-plugin', externals })
    .target('compiled/optimize-css-assets-webpack-plugin');
}

externals['os-locale'] = '@noaejs/deps/compiled/os-locale';
export async function ncc_os_locale(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('os-locale')))
    .ncc({ packageName: 'os-locale', externals })
    .target('compiled/os-locale');
}

externals['p-limit'] = '@noaejs/deps/compiled/p-limit';
...
externals['pkg-up'] = '@noaejs/deps/compiled/pkg-up';
export async function ncc_pkg_up(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('pkg-up')))
    .ncc({ packageName: 'pkg-up', externals })
    .target('compiled/pkg-up');
}

externals['portfinder'] = '@noaejs/deps/compiled/portfinder';
export async function ncc_portfinder(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('portfinder')))
    .ncc({ packageName: 'portfinder', externals })
    .target('compiled/portfinder');
}

externals['raw-loader'] = '@noaejs/deps/compiled/raw-loader';
export async function ncc_raw_loader(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('raw-loader')))
    .ncc({ packageName: 'raw-loader', externals })
    .target('compiled/raw-loader');
}

externals['resolve'] = '@noaejs/deps/compiled/resolve';
...
externals['resolve-cwd'] = '@noaejs/deps/compiled/resolve-cwd';
export async function ncc_resolve_cwd(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('resolve-cwd')))
    .ncc({ packageName: 'resolve-cwd', externals })
    .target('compiled/resolve-cwd');
}

externals['rimraf'] = '@noaejs/deps/compiled/rimraf';
export async function ncc_rimraf(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('rimraf')))
    .ncc({ packageName: 'rimraf', externals })
    .target('compiled/rimraf');
}

externals['semver'] = '@noaejs/deps/compiled/semver';
...
externals['set-value'] = '@noaejs/deps/compiled/set-value';
export async function ncc_set_value(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('set-value')))
    .ncc({ packageName: 'set-value', externals })
    .target('compiled/set-value');
}

externals['signale'] = '@noaejs/deps/compiled/signale';
export async function ncc_signale(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('signale')))
    .ncc({ packageName: 'signale', externals })
    .target('compiled/signale');
}

externals['serialize-javascript'] = '@noaejs/deps/compiled/serialize-javascript';
export async function ncc_serialize_javascript(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('serialize-javascript')))
    .ncc({ packageName: 'serialize-javascript', externals })
    .target('compiled/serialize-javascript');
}

externals['sockjs'] = '@noaejs/deps/compiled/sockjs';
...
// externals['source-map'] = '@noaejs/deps/compiled/source-map';
...
externals['spdy'] = '@noaejs/deps/compiled/spdy';
export async function ncc_spdy(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('spdy')))
    .ncc({ packageName: 'spdy', externals })
    .target('compiled/spdy');
}

externals['speed-measure-webpack-plugin'] = '@noaejs/deps/compiled/speed-measure-webpack-plugin';
...
externals['stats-webpack-plugin'] = '@noaejs/deps/compiled/stats-webpack-plugin';
export async function ncc_stats_webpack_plugin(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('stats-webpack-plugin')))
    .ncc({ packageName: 'stats-webpack-plugin', externals })
    .target('compiled/stats-webpack-plugin');
}

externals['style-loader'] = '@noaejs/deps/compiled/style-loader';
...
// do not external!
// externals['tapable'] = '@noaejs/deps/compiled/tapable';
...
externals['yargs-parser'] = '@noaejs/deps/compiled/yargs-parser';
export async function ncc_yargs_parser(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('yargs-parser')))
...
externals['webpack-chain'] = '@noaejs/deps/compiled/webpack-chain';
export async function ncc_webpack_chain(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('webpack-chain')))
    .ncc({ packageName: 'webpack-chain', externals })
    .target('compiled/webpack-chain');
}

externals['webpack-dev-middleware'] = '@noaejs/deps/compiled/webpack-dev-middleware';
...
externals['webpack-manifest-plugin'] = '@noaejs/deps/compiled/webpack-manifest-plugin';
export async function ncc_webpack_manifest_plugin(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('webpack-manifest-plugin')))
    .ncc({ packageName: 'webpack-manifest-plugin', externals })
    .target('compiled/webpack-manifest-plugin');
}

externals['webpackbar'] = '@noaejs/deps/compiled/webpackbar';
export async function ncc_webpackbar(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('webpackbar')))
    .ncc({ packageName: 'webpackbar', externals })
    .target('compiled/webpackbar');
}

externals['yargs'] = '@noaejs/deps/compiled/yargs';
...
// externals['webpack-sources2'] = '@noaejs/deps/compiled/webpack-sources2'
export async function ncc_webpack_sources2(task, opts) {
  await task
    .source(opts.src || relative(__dirname, bundleRequire.resolve('webpack-sources2')))
    .ncc({ packageName: 'webpack-sources2', externals, target: 'es5' })
    .target('compiled/webpack-sources2');
}

externals['webpack'] = '@noaejs/deps/compiled/webpack/webpack';
...
export async function ncc_webpack_bundle5(task, opts) {
  await task
    ...
    .ncc({
      ...
      externals: {
        ...externals,
        'webpack-sources': '@noaejs/deps/compiled/webpack-sources2',
      },
      minify: false,
      target: 'es5',
    })
...
export async function ncc_worker_loader(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('worker-loader')))
    .ncc({
...
externals['@hapi/joi'] = '@noaejs/deps/compiled/@hapi/joi';
export async function ncc_hapi_joi(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('@hapi/joi')))
    .ncc({ packageName: '@hapi/joi', externals })
    .target('compiled/@hapi/joi');
}

externals['joi2types'] = '@noaejs/deps/compiled/joi2types';
export async function ncc_joi2types(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('joi2types')))
    .ncc({ packageName: 'joi2types', externals })
    .target('compiled/joi2types');
}

// 放到 webpack 和 @babel/core 后面
externals['babel-loader'] = '@noaejs/deps/compiled/babel-loader';
...
export async function ncc_webpack_bundle_packages(task, opts) {
  await task.source(opts.src || 'bundles/webpack/packages/*').target('compiled/webpack/');
}
